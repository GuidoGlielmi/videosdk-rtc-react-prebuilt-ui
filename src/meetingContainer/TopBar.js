...
const ActivitiesBTN = ({onClick, isMobile, isTab}) => {
  ...
  return isMobile || isTab ? (
    <MobileIconButton
      Icon={Activities}
      tooltipTitle={'Más Opciones'}
      buttonText={'Más Opciones'}
...
const AddLiveStreamBTN = ({isMobile, isTab}) => {
  ...
  return isMobile || isTab ? (
    <MobileIconButton
      tooltipTitle={'Añadir Live Stream'}
      Icon={AddLiveStreamIcon}
      buttonText={'Añadir Live Stream'}
...
const WebcamBTN = () => {
  ...
  return (
    ...
    >
      <OutlineIconButton
        btnID={'btnWebcam'}
        tooltipTitle={localWebcamOn ? 'Apagar cámara' : 'Prender cámara'}
        ...
        renderRightComponent={() => {
          return (
            <Tooltip placement='bottom' title={'Cambiar cámara'}>
              <IconButton
                onClick={e => {
  ...
  return (
    ...
    >
      <OutlineIconButton
        btnID={'btnMic'}
        tooltipTitle={
          isNoiseRemovalChecked ? 'Noise Removal Activated' : localMicOn ? 'Apagar micrófono' : 'Prender micrófono'
        }
        ...
        renderRightComponent={() => {
          return (
            <Tooltip placement='bottom' title={'Cambiar micrófono'}>
              <IconButton
                onClick={e => {
